...
public interface ResponseHandlerInterface {
	 ...
	 *
	 * @param usePoolThread
	 *            if the ResponseHandler should run on pool's thread
	 */
	void setUsePoolThread(boolean usePoolThread);

	/**
	 * Returns whether the handler should be executed on the pool's thread or
	 * the UI thread
	 *
	 ...
	 * processed by the system. The library makes sure that a single response is
